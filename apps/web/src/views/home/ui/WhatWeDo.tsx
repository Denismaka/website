...
import { GraduationCap, Trophy, Users, GitBranch } from "lucide-react";
import { Card, CardContent, CardDescription, CardTitle, TiltCard } from "@/shared/ui";
import { useTranslations } from "@/shared/i18n";

const icons = [GraduationCap, Trophy, Users, GitBranch];
const colors = [
        ...
        <section className="px-6 py-24">
            <div className="mx-auto max-w-6xl">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-4 text-lg text-muted-foreground text-balance">{t.whatWeDo.subtitle}</p>
                </div>
